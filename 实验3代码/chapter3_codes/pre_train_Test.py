...
df_table_all = pd.read_csv("/home/user/-3/实验3代码/chapter3_data_handled/test_all.csv", index_col=0)
...
df_table_all.to_csv("/home/user/-3/实验3代码/chapter3_data_handled/testafter.csv")
print('testafter shape:', df_table_all.shape)
