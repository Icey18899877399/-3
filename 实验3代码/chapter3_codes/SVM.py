...
np.savetxt(
    r'/home/user/-3/实验3代码/chapter3_data_handled/SVM.txt',
    output,
    fmt="%d %0.9f %d"
)
...
def report_auc(y_true, y_prob, title="", output_name="", lw=2):
    ...
    plt.savefig(r"/home/user/-3/实验3代码/chapter3_data_handled/SVM_L1_" + output_name, dpi=800)
    plt.close()

# 绘图
report_auc(y_test, y_prob, 'SVM with L1 feature selection', 'svm')