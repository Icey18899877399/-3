...
# 随机森林训练（注意：用的是处理后的数据）
rf = RandomForestClassifier(n_estimators=100, n_jobs=-1, criterion='gini', random_state=0)
...
# 绘图
report_auc(y_test, y_prob, 'Random Forest with L1 feature selection', "result")