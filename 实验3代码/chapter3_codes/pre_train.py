...
df_table_all = pd.read_csv("D:\文档\机器学习\实验3代码\chapter3_data_handled\\train_all.csv", index_col=0)
...
df_table_all.to_csv("D:\文档\机器学习\实验3代码\chapter3_data_handled\\trainafter.csv")
